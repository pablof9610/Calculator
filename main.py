...
lb_master = Label(calc, text='0',
                  font='Arial 15')
btn1 = Button(calc, text='1', command=lambda: setlabelvalue(1), width=6, padx=3)
btn2 = Button(calc, text='2', command=lambda: setlabelvalue(2), width=6)
btn3 = Button(calc, text='3', command=lambda: setlabelvalue(3), width=6)
btn4 = Button(calc, text='4', command=lambda: setlabelvalue(4), width=6)
btn5 = Button(calc, text='5', command=lambda: setlabelvalue(5), width=6)
btn6 = Button(calc, text='6', command=lambda: setlabelvalue(6), width=6)
btn7 = Button(calc, text='7', command=lambda: setlabelvalue(7), width=6)
btn8 = Button(calc, text='8', command=lambda: setlabelvalue(8), width=6)
btn9 = Button(calc, text='9', command=lambda: setlabelvalue(9), width=6)
btn0 = Button(calc, text='0', command=lambda: setlabelvalue(0), width=6)
btn_add = Button(calc, text='+', width=10, command=lambda: setopbfn(1, lb_master['text']))
btn_dim = Button(calc, text='-', width=10, command=lambda: setopbfn(2, lb_master['text']))
btn_div = Button(calc, text='/', width=10, command=lambda: setopbfn(3, lb_master['text']))
btn_mult = Button(calc, text='*', width=10, command=lambda: setopbfn(4, lb_master['text']))
btn_rs = Button(calc, text='=', width=10, command=lambda: result(lb_master['text'], op))
